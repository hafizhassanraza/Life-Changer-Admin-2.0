...
class FragmentWithdrawRecord : Fragment() {

    private var _binding: FragmentWithdrawRecordBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentWithdrawRecordBinding.inflate(inflater, container, false)
        ...
        binding.pdfWDRecord.setOnClickListener { generatePDF() }
        getRequests()
        return root
    }
    ...
    private fun generatePDF() {
        val intent = Intent(Intent.ACTION_CREATE_DOCUMENT).apply {
            ...
            putExtra(Intent.EXTRA_TITLE, "withdraw-record.pdf")
        }
                ...
                .addOnCompleteListener { task ->
                    if (task.isSuccessful) {
                        ...
                        if (task.result.size() > 0) {
                            ...
                            binding.rvWithdrawApproved .adapter = InvestorTransactionsAdapter(
                                constants.FROM_APPROVED_WITHDRAW_REQ,
