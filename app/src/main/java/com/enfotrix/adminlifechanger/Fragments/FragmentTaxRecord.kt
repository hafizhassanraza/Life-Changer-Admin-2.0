...
class FragmentTaxRecord : Fragment() {

    private var _binding: FragmentTaxRecordBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTaxRecordBinding.inflate(inflater, container, false)
                ...
                .addOnCompleteListener { task ->
                    if (task.isSuccessful) {
                        ...
                        if (task.result.size() > 0) {
                            ...
                            binding.rvTax .adapter = InvestorTransactionsAdapter(
                                constants.FROM_TAX,
