...
class FragmentInvestRecord : Fragment() {

    private var _binding: FragmentInvestRecordBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentInvestRecordBinding.inflate(inflater, container, false)
        ...
        binding.rvInvestRequest.layoutManager = LinearLayoutManager(mContext)

        binding.pdfInvestmentRecord.setOnClickListener { generatePDF() }
    ...
    private fun generatePDF() {
        val intent = Intent(Intent.ACTION_CREATE_DOCUMENT).apply {
            ...
            putExtra(Intent.EXTRA_TITLE, "investment-record.pdf")
        }
                ...
                .addOnCompleteListener { task ->
                    if (task.isSuccessful) {
                        ...
                        if (task.result.size() > 0) {
                            ...
                            binding.rvInvestRequest .adapter = InvestorTransactionsAdapter(
                                constants.FROM_APPROVED_INVESTMENT_REQ,
